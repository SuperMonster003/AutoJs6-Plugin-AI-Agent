...
| 最低宿主 versionCode | `AiAgentPlugin.REQUIRED_HOST_VERSION` = 5286 (AutoJs6 6.8.0, P3.1 附加脚本目录配置的宿主校验与恢复) |
...
- README 先说明用户能完成什么, 再说明安装与使用; 不写 Android Studio 或 IntelliJ IDEA 版本信息, 不向普通用户解释 `supportedAbis`, 签名过程等实现细节. README 与插件说明 MUST 如实标明当前阶段 (P2.5 宿主接入开发预览, 脚本 API 与完整任务台仍分别在 P5/P6).
