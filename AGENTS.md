...
- README 先说明用户能完成什么, 再说明安装与使用; 不写 Android Studio 或 IntelliJ IDEA 版本信息, 不向普通用户解释 `supportedAbis`, 签名过程等实现细节. README 与插件说明 MUST 如实标明当前阶段 (开发预览, P5 脚本 API, P6.1 任务台与 P6.2 历史已接通, 预设及其他界面仍按 P6.3-P6.7 继续).
