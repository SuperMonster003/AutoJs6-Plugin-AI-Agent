...
- README 先说明用户能完成什么, 再说明安装与使用; 不写 Android Studio 或 IntelliJ IDEA 版本信息, 不向普通用户解释 `supportedAbis`, 签名过程等实现细节. README 与插件说明 MUST 如实标明当前阶段 (开发预览, P5 脚本 API 与 P6 任务界面/设置/悬浮球/系统入口已接通; P7/P8 尚未通过).
