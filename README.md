...
- `提示` 1.0.0 开发预览. 任务 API 与各界面入口已实现, P7 审计证据已记录. P8 发布检查与正式发布尚未完成. 已通过用例和已知限制见 [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
