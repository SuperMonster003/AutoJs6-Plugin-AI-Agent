...
> 开发预览: P6.1 任务台与 P6.2 任务历史已可用. ai.agent API 需要 AutoJs6 build 5293 或更高版本. 自定义预设及其他界面继续按 P6.3-P6.7 实施, 健壮性与发布门槛仍在 P7/P8.
...
- `提示` 开发预览: P6.1 任务台与 P6.2 任务历史已可用. ai.agent API 需要 AutoJs6 build 5293 或更高版本. 自定义预设及其他界面继续按 P6.3-P6.7 实施, 健壮性与发布门槛仍在 P7/P8.
