...
开发预览: 已提供任务台, 历史, 预设, 记忆, 设置, 发行历史与手动更新检查. ai.agent API 要求 AutoJs6 构建号不低于 5293. 悬浮球与外部入口继续按 P6.7 实施; 可靠性与发布门禁仍在 P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 开发预览: 已提供任务台, 历史, 预设, 记忆, 设置, 发行历史与手动更新检查. ai.agent API 要求 AutoJs6 构建号不低于 5293. 悬浮球与外部入口继续按 P6.7 实施; 可靠性与发布门禁仍在 P7/P8.
...
- INTERNET 仅用于手动检查 GitHub 发行版本. FOREGROUND_SERVICE 与 FOREGROUND_SERVICE_SPECIAL_USE 用于运行中的任务, POST_NOTIFICATIONS 用于进度与停止操作. 不申请无障碍, 悬浮窗, 存储或麦克风权限.
...
- `提示` 开发预览: 已提供任务台, 历史, 预设, 记忆, 设置, 发行历史与手动更新检查. ai.agent API 要求 AutoJs6 构建号不低于 5293. 悬浮球与外部入口继续按 P6.7 实施; 可靠性与发布门禁仍在 P7/P8.
