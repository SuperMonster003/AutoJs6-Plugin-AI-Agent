...
object AiAgentPlugin {
    ...
    /**
     * Minimum AutoJs6 `versionCode` shipping P4.1 optional OCR availability
     * discovery together with the P3.3 registered-script execution contract.
     */
    const val REQUIRED_HOST_VERSION = 5288L
}
