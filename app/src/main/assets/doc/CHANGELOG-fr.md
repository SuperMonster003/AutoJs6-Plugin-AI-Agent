...
* `Note` Le contrat AI Agent, le relais de fonctions limitées et le relais de modèles avec quotas sont implémentés dans l'hôte. L'exécution des tâches du plugin reste en développement
