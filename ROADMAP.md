...
P4.4 部分状态 (2026-09-24): 夜间首轮暂缓的 Wi-Fi 已在用户补充联网条件后完成三台补测. 夜间因星巴克非营业而进行的金鼎轩补充流程仅创建一笔 85.30 元订单, 付款请求被拒绝, 最后支付超时自动取消. 日间用户允许恢复原星巴克测试, 新一轮仍限定最多一笔待付款且不实际支付. 两轮订单分别计数, 不将金鼎轩替代原星巴克条目. 购物细节, 模型错误叙述与节点诊断见同日证据文档.
