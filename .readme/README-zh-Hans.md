...
> 开发预览: 任务台已支持目标输入, 进度, 内联回答与最近任务详情. ai.agent 任务 API 需要 AutoJs6 build 5293 或更高版本. 历史管理, 自定义预设与其他入口继续按 P6 实施, 健壮性验收仍在 P7.
...
- `提示` 开发预览: 任务台已支持目标输入, 进度, 内联回答与最近任务详情. ai.agent 任务 API 需要 AutoJs6 build 5293 或更高版本. 历史管理, 自定义预设与其他入口继续按 P6 实施, 健壮性验收仍在 P7.
