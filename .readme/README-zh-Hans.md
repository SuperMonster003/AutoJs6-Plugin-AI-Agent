...
开发预览: P6.1-P6.4 已提供任务台, 历史, 预设与偏好记忆. ai.agent API 要求 AutoJs6 构建号不低于 5293. 其余界面继续按 P6.5-P6.7 实施, 可靠性与发布门禁仍在 P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 开发预览: P6.1-P6.4 已提供任务台, 历史, 预设与偏好记忆. ai.agent API 要求 AutoJs6 构建号不低于 5293. 其余界面继续按 P6.5-P6.7 实施, 可靠性与发布门禁仍在 P7/P8.
...
- `提示` 开发预览: P6.1-P6.4 已提供任务台, 历史, 预设与偏好记忆. ai.agent API 要求 AutoJs6 构建号不低于 5293. 其余界面继续按 P6.5-P6.7 实施, 可靠性与发布门禁仍在 P7/P8.
