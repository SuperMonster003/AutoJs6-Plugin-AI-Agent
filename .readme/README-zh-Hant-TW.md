...
開發預覽: P6.1-P6.4 已提供任務台, 歷史, 預設與偏好記憶. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 其餘介面繼續按 P6.5-P6.7 實施, 可靠性與發佈門檻仍在 P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 開發預覽: P6.1-P6.4 已提供任務台, 歷史, 預設與偏好記憶. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 其餘介面繼續按 P6.5-P6.7 實施, 可靠性與發佈門檻仍在 P7/P8.
...
- `提示` 開發預覽: P6.1-P6.4 已提供任務台, 歷史, 預設與偏好記憶. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 其餘介面繼續按 P6.5-P6.7 實施, 可靠性與發佈門檻仍在 P7/P8.
