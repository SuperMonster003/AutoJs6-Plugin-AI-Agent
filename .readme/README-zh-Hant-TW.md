...
開發預覽: 任務台已支援目標輸入, 進度, 內嵌回答與最近任務詳情. ai.agent 任務 API 需要 AutoJs6 build 5293 或更新版本. 歷史管理, 自訂預設與其他入口繼續按 P6 實施, 穩健性驗收仍在 P7. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 開發預覽: 任務台已支援目標輸入, 進度, 內嵌回答與最近任務詳情. ai.agent 任務 API 需要 AutoJs6 build 5293 或更新版本. 歷史管理, 自訂預設與其他入口繼續按 P6 實施, 穩健性驗收仍在 P7.
...
- `提示` 開發預覽: 任務台已支援目標輸入, 進度, 內嵌回答與最近任務詳情. ai.agent 任務 API 需要 AutoJs6 build 5293 或更新版本. 歷史管理, 自訂預設與其他入口繼續按 P6 實施, 穩健性驗收仍在 P7.
