...
> 開發預覽: P6.1-P6.5 已提供任務台, 歷史, 預設與偏好記憶. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 其餘介面繼續按 P6.6-P6.7 實施, 可靠性與發佈門檻仍在 P7/P8.
...
- 不申請網路權限. FOREGROUND_SERVICE 與 FOREGROUND_SERVICE_SPECIAL_USE 用於執行中的任務, POST_NOTIFICATIONS 用於顯示進度與停止操作. 不申請無障礙或懸浮視窗權限.
...
- `提示` 開發預覽: P6.1-P6.5 已提供任務台, 歷史, 預設與偏好記憶. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 其餘介面繼續按 P6.6-P6.7 實施, 可靠性與發佈門檻仍在 P7/P8.
