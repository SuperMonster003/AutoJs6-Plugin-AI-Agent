...
開發預覽: 登記腳本, 畫面操作與 ai.agent 任務 API 已接通. 任務 API 需要 AutoJs6 組建 5293 或更高版本; 完整任務台繼續按 P6 實施, 穩定性驗收繼續按 P7 實施. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
- `提示` 開發預覽: 登記腳本, 畫面操作與 ai.agent 任務 API 已接通. 任務 API 需要 AutoJs6 組建 5293 或更高版本; 完整任務台繼續按 P6 實施, 穩定性驗收繼續按 P7 實施.
