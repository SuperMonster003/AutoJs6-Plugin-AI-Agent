...
開發預覽: 已提供任務台, 歷史, 預設, 記憶, 設定, 發行歷史與手動更新檢查. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 懸浮球與外部入口繼續按 P6.7 實作; 可靠性與發佈門檻仍在 P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 開發預覽: 已提供任務台, 歷史, 預設, 記憶, 設定, 發行歷史與手動更新檢查. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 懸浮球與外部入口繼續按 P6.7 實作; 可靠性與發佈門檻仍在 P7/P8.
...
- `提示` 開發預覽: 已提供任務台, 歷史, 預設, 記憶, 設定, 發行歷史與手動更新檢查. ai.agent API 要求 AutoJs6 建置編號不低於 5293. 懸浮球與外部入口繼續按 P6.7 實作; 可靠性與發佈門檻仍在 P7/P8.
