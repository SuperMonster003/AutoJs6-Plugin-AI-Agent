...
> 開發預覽: P6.1 任務台與 P6.2 任務歷史已可用. ai.agent API 需要 AutoJs6 build 5293 或更新版本. 自訂預設及其他介面繼續按 P6.3-P6.7 實施, 穩健性與發佈門檻仍在 P7/P8.
...
- `提示` 開發預覽: P6.1 任務台與 P6.2 任務歷史已可用. ai.agent API 需要 AutoJs6 build 5293 或更新版本. 自訂預設及其他介面繼續按 P6.3-P6.7 實施, 穩健性與發佈門檻仍在 P7/P8.
