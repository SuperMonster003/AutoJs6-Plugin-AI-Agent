...
- `提示` 1.0.0 開發預覽. 任務 API 與各介面入口已實現, P7 審核證據已記錄. P8 發佈檢查與正式發佈尚未完成. 已通過案例及已知限制見 [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
