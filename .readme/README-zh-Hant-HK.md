...
> 開發預覽: 任務台已支援目標輸入, 進度, 內聯回答與最近任務詳情. ai.agent 任務 API 需要 AutoJs6 build 5293 或更新版本. 歷史管理, 自訂預設與其他入口繼續按 P6 實施, 穩健性驗收仍在 P7.
...
- `提示` 開發預覽: 任務台已支援目標輸入, 進度, 內聯回答與最近任務詳情. ai.agent 任務 API 需要 AutoJs6 build 5293 或更新版本. 歷史管理, 自訂預設與其他入口繼續按 P6 實施, 穩健性驗收仍在 P7.
