...
開發預覽: 登記腳本已接通參數詢問, 執行確認, 結果上報和取消. 介面操作流程繼續在 P4 完善, 任務腳本 API 與完整任務台仍在 P5/P6. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
開發預覽: 登記腳本已接通參數詢問, 執行確認, 結果上報和取消. 介面操作流程繼續在 P4 完善, 任務腳本 API 與完整任務台仍在 P5/P6.
...
1. 在安裝了 AutoJs6 組建 5287 或更高版本的裝置上, 從 [Releases](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/releases) 安裝外掛 APK.
...
- `提示` 開發預覽: 登記腳本已接通參數詢問, 執行確認, 結果上報和取消. 介面操作流程繼續在 P4 完善, 任務腳本 API 與完整任務台仍在 P5/P6.
...
- `依賴` 附加同一 AutoJs6 6.8.0 / 5287 release 建置的 common-plugin-api, host-capability-api 與 ai-agent-api (MPL 2.0), 透過 SHA-256 鎖定
