...
> 開発プレビュー: P6.1 のタスク画面と P6.2 のタスク履歴を利用できます. ai.agent API には AutoJs6 build 5293 以降が必要です. カスタムプリセットなどは P6.3-P6.7, 信頼性とリリースの検証は P7/P8 で続けます.
...
- `ヒント` 開発プレビュー: P6.1 のタスク画面と P6.2 のタスク履歴を利用できます. ai.agent API には AutoJs6 build 5293 以降が必要です. カスタムプリセットなどは P6.3-P6.7, 信頼性とリリースの検証は P7/P8 で続けます.
