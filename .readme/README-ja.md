...
- `ヒント` 1.0.0 開発プレビュー. タスク API と各画面の入口は実装済みで, P7 監査の証拠も記録済みです. P8 のリリース確認と公開は未完了です. 合格例と既知の制限は [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md) を参照してください.
