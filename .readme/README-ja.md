...
> 開発プレビュー: タスク画面で目標入力, 進捗表示, インライン回答, 最近のタスク詳細に対応. ai.agent タスク API には AutoJs6 build 5293 以降が必要です. 履歴管理や独自プリセットなどは P6, 堅牢性の検証は P7 で続行します.
...
- `ヒント` 開発プレビュー: タスク画面で目標入力, 進捗表示, インライン回答, 最近のタスク詳細に対応. ai.agent タスク API には AutoJs6 build 5293 以降が必要です. 履歴管理や独自プリセットなどは P6, 堅牢性の検証は P7 で続行します.
