...
開発プレビュー: P6.1-P6.5 はタスク画面, 履歴, プリセットと設定の記憶を提供します. ai.agent API には AutoJs6 ビルド 5293 以降が必要です. 残りの画面は P6.6-P6.7, 信頼性とリリース条件は P7/P8 で実装します. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 開発プレビュー: P6.1-P6.5 はタスク画面, 履歴, プリセットと設定の記憶を提供します. ai.agent API には AutoJs6 ビルド 5293 以降が必要です. 残りの画面は P6.6-P6.7, 信頼性とリリース条件は P7/P8 で実装します.
...
- `ヒント` 開発プレビュー: P6.1-P6.5 はタスク画面, 履歴, プリセットと設定の記憶を提供します. ai.agent API には AutoJs6 ビルド 5293 以降が必要です. 残りの画面は P6.6-P6.7, 信頼性とリリース条件は P7/P8 で実装します.
