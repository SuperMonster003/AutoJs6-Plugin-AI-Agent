...
Предварительная версия 1.0.0. API задач и входы интерфейса реализованы; результаты аудита P7 записаны. Проверки выпуска и публикация P8 еще не завершены. Пройденные случаи и ограничения см. в [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
- `Подсказка` Предварительная версия: доступны экраны P6, настройки, плавающая кнопка, отправка текста, ярлыки и голосовые черновики. Для ai.agent нужен AutoJs6 build 5293 или новее. Проверки надежности и выпуска P7/P8 еще не завершены.
- `Функция` Необязательные плавающие ввод, ход, остановка и подтверждения, отправка текста, статические и закрепленные ярлыки пресетов, системный голосовой ввод без автоматической отправки
