...
> Предварительная версия: доступны ввод цели, прогресс, ответы в карточке и подробности недавних задач. API ai.agent требует AutoJs6 build 5293 или новее. Управление историей, свои наборы настроек и другие точки входа остаются в P6, проверка надежности в P7.
...
- `Подсказка` Предварительная версия: доступны ввод цели, прогресс, ответы в карточке и подробности недавних задач. API ai.agent требует AutoJs6 build 5293 или новее. Управление историей, свои наборы настроек и другие точки входа остаются в P6, проверка надежности в P7.
