...
Предварительная версия: подключены зарегистрированные скрипты, действия на экране и API задач ai.agent. API требуют AutoJs6 build 5293 или новее; полный интерфейс продолжается в P6, проверка надежности в P7. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
- `Подсказка` Предварительная версия: подключены зарегистрированные скрипты, действия на экране и API задач ai.agent. API требуют AutoJs6 build 5293 или новее; полный интерфейс продолжается в P6, проверка надежности в P7.
