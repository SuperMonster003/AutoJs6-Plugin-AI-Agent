...
Предварительная версия: доступны задачи, история, профили, память, настройки, история выпусков и ручная проверка обновлений. Для ai.agent нужен AutoJs6 build 5293 или новее. Плавающий интерфейс и внешние входы продолжаются в P6.7; проверки надежности и выпуска остаются в P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> Предварительная версия: доступны задачи, история, профили, память, настройки, история выпусков и ручная проверка обновлений. Для ai.agent нужен AutoJs6 build 5293 или новее. Плавающий интерфейс и внешние входы продолжаются в P6.7; проверки надежности и выпуска остаются в P7/P8.
...
- INTERNET используется только для ручной проверки выпусков GitHub. FOREGROUND_SERVICE и FOREGROUND_SERVICE_SPECIAL_USE обслуживают активные задачи; POST_NOTIFICATIONS показывает прогресс и остановку. Разрешения специальных возможностей, наложения, хранилища и микрофона не запрашиваются.
