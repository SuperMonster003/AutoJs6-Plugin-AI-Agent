...
- `Подсказка` Контракт AI Agent, посредник ограниченного доступа к функциям хоста и посредник моделей с квотами реализованы. Выполнение задач плагином остается в разработке
