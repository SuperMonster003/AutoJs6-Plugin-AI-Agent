...
Предварительная версия: доступны экраны P6, настройки, плавающая кнопка, отправка текста, ярлыки и голосовые черновики. Для ai.agent нужен AutoJs6 build 5293 или новее. Проверки надежности и выпуска P7/P8 еще не завершены. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
