...
> Предварительная версия: P6.1-P6.5 включают задачи, историю, профили и память предпочтений. API ai.agent требует AutoJs6 сборки 5293 или новее. Остальные интерфейсы остаются в P6.6-P6.7, проверки надежности и выпуска в P7/P8.
...
- `Подсказка` Предварительная версия: P6.1-P6.5 включают задачи, историю, профили и память предпочтений. API ai.agent требует AutoJs6 сборки 5293 или новее. Остальные интерфейсы остаются в P6.6-P6.7, проверки надежности и выпуска в P7/P8.
