...
Предварительная версия: подключены зарегистрированные скрипты, действия на экране и API задач ai.agent. API требуют AutoJs6 build 5293 или новее; полный интерфейс продолжается в P6, проверка надежности в P7.
...
> Предварительная версия: P6.1-P6.3 включают экран задач, историю и именованные предустановки. Для ai.agent требуется AutoJs6 build 5293 или новее. Управление памятью и остальные экраны запланированы в P6.4-P6.7, проверки надежности и выпуска остаются в P7/P8.
...
- `Подсказка` Предварительная версия: P6.1-P6.3 включают экран задач, историю и именованные предустановки. Для ai.agent требуется AutoJs6 build 5293 или новее. Управление памятью и остальные экраны запланированы в P6.4-P6.7, проверки надежности и выпуска остаются в P7/P8.
