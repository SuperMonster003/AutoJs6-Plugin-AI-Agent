...
Предварительная версия: P6.1-P6.4 включают задачи, историю, профили и память предпочтений. API ai.agent требует AutoJs6 сборки 5293 или новее. Остальные интерфейсы остаются в P6.5-P6.7, проверки надежности и выпуска в P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> Предварительная версия: P6.1-P6.4 включают задачи, историю, профили и память предпочтений. API ai.agent требует AutoJs6 сборки 5293 или новее. Остальные интерфейсы остаются в P6.5-P6.7, проверки надежности и выпуска в P7/P8.
...
- `Подсказка` Предварительная версия: P6.1-P6.4 включают задачи, историю, профили и память предпочтений. API ai.agent требует AutoJs6 сборки 5293 или новее. Остальные интерфейсы остаются в P6.5-P6.7, проверки надежности и выпуска в P7/P8.
