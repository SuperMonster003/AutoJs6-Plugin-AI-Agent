...
1. Установите APK плагина со страницы [Releases](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/releases) на устройство с AutoJs6 сборки 5288 или новее.
...
- `Улучшение` Минимальный хост AutoJs6 6.8.0 / сборка 5288 обеспечивает обнаружение доступности OCR и проверку разрешений
- `Зависимость` Добавлены common-plugin-api, host-capability-api и ai-agent-api из одной release-сборки AutoJs6 6.8.0 / 5288 (MPL 2.0), закреплены SHA-256
