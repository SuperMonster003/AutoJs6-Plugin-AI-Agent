...
Установленная версия пока показывает только состояние хоста. Интерфейсы хоста P1 и ядра инструментов, решений и исполнения P2.1-P2.3 реализованы и проверены. Реальное выполнение требует подключения модели/хоста P2.4/P2.5 и адаптеров P3/P4. API скриптов и интерфейс задач появятся в P5/P6. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
