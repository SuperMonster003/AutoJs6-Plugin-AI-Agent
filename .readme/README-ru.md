...
> Предварительная версия: доступны панель задач P6.1 и история P6.2. API ai.agent требует AutoJs6 build 5293 или новее. Пользовательские наборы настроек и другие интерфейсы продолжаются в P6.3-P6.7; проверка надежности и выпуска остается в P7/P8.
...
- `Подсказка` Предварительная версия: доступны панель задач P6.1 и история P6.2. API ai.agent требует AutoJs6 build 5293 или новее. Пользовательские наборы настроек и другие интерфейсы продолжаются в P6.3-P6.7; проверка надежности и выпуска остается в P7/P8.
