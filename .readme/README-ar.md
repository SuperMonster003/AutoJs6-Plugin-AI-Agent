...
معاينة تطوير: تتوفر المهام والسجل والإعدادات المسبقة والذاكرة والإعدادات وسجل الإصدارات والفحص اليدوي للتحديثات. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. تستمر المداخل العائمة والخارجية في P6.7 واختبارات الموثوقية والنشر في P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> معاينة تطوير: تتوفر المهام والسجل والإعدادات المسبقة والذاكرة والإعدادات وسجل الإصدارات والفحص اليدوي للتحديثات. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. تستمر المداخل العائمة والخارجية في P6.7 واختبارات الموثوقية والنشر في P7/P8.
...
- يستخدم INTERNET لفحص إصدارات GitHub يدويا فقط. تدعم FOREGROUND_SERVICE وFOREGROUND_SERVICE_SPECIAL_USE المهام النشطة وتعرض POST_NOTIFICATIONS التقدم والإيقاف. لا تطلب أذونات إمكانية الوصول أو التراكب أو التخزين أو الميكروفون.
...
- `تلميح` معاينة تطوير: تتوفر المهام والسجل والإعدادات المسبقة والذاكرة والإعدادات وسجل الإصدارات والفحص اليدوي للتحديثات. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. تستمر المداخل العائمة والخارجية في P6.7 واختبارات الموثوقية والنشر في P7/P8.
