...
1. ثبت ملف APK للمكون الإضافي من [Releases](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/releases) على جهاز به AutoJs6 بالبناء 5288 أو أحدث.
...
- `تحسين` الحد الأدنى للمضيف هو AutoJs6 6.8.0 / البناء 5288 لاكتشاف توفر OCR والتحقق من أذوناته
- `تبعية` إضافة common-plugin-api و host-capability-api و ai-agent-api من نفس بناء release لـ AutoJs6 6.8.0 / 5288 (MPL 2.0), مثبتة بواسطة SHA-256
