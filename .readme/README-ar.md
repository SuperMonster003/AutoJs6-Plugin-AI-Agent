...
> معاينة تطوير: توفر P6.1-P6.3 شاشة المهام وسجلها والإعدادات المسبقة المسماة. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. تتبع إدارة الذاكرة وبقية الواجهات في P6.4-P6.7, وتبقى اختبارات الاعتمادية والإصدار في P7/P8.
...
- `تلميح` معاينة تطوير: توفر P6.1-P6.3 شاشة المهام وسجلها والإعدادات المسبقة المسماة. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. تتبع إدارة الذاكرة وبقية الواجهات في P6.4-P6.7, وتبقى اختبارات الاعتمادية والإصدار في P7/P8.
