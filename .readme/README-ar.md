...
معاينة تطوير: توفر P6.1-P6.4 المهام والسجل والإعدادات المسبقة وذاكرة التفضيلات. تتطلب واجهة ai.agent إصدار AutoJs6 رقم 5293 أو أحدث. تبقى الواجهات الأخرى ضمن P6.5-P6.7 واختبارات الاعتمادية والإصدار ضمن P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> معاينة تطوير: توفر P6.1-P6.4 المهام والسجل والإعدادات المسبقة وذاكرة التفضيلات. تتطلب واجهة ai.agent إصدار AutoJs6 رقم 5293 أو أحدث. تبقى الواجهات الأخرى ضمن P6.5-P6.7 واختبارات الاعتمادية والإصدار ضمن P7/P8.
...
- `تلميح` معاينة تطوير: توفر P6.1-P6.4 المهام والسجل والإعدادات المسبقة وذاكرة التفضيلات. تتطلب واجهة ai.agent إصدار AutoJs6 رقم 5293 أو أحدث. تبقى الواجهات الأخرى ضمن P6.5-P6.7 واختبارات الاعتمادية والإصدار ضمن P7/P8.
