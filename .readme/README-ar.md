...
> نسخة تطوير: تدعم لوحة المهام إدخال الأهداف والتقدم والإجابات المضمنة وتفاصيل المهام الأخيرة. تتطلب واجهة ai.agent إصدار AutoJs6 build 5293 أو أحدث. تستمر إدارة السجل والإعدادات المخصصة والمداخل الأخرى في P6 والتحقق من المتانة في P7.
...
- `تلميح` نسخة تطوير: تدعم لوحة المهام إدخال الأهداف والتقدم والإجابات المضمنة وتفاصيل المهام الأخيرة. تتطلب واجهة ai.agent إصدار AutoJs6 build 5293 أو أحدث. تستمر إدارة السجل والإعدادات المخصصة والمداخل الأخرى في P6 والتحقق من المتانة في P7.
