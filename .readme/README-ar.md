...
معاينة تطوير: تدعم السكربتات المسجلة أسئلة المعلمات والتأكيد والنتائج والإلغاء. تستمر عمليات الشاشة في P4 وتأتي واجهات المهام ولوحة العمل في P5/P6.
...
- `تلميح` معاينة تطوير: تدعم السكربتات المسجلة أسئلة المعلمات والتأكيد والنتائج والإلغاء. تستمر عمليات الشاشة في P4 وتأتي واجهات المهام ولوحة العمل في P5/P6.
...
- `تحسين` الحد الأدنى للمضيف هو AutoJs6 6.8.0 / البناء 5287 لاستقبال مجلدات السكربتات الإضافية المحددة في الإضافة والتحقق منها
- `تبعية` إضافة common-plugin-api و host-capability-api و ai-agent-api من نفس بناء release لـ AutoJs6 6.8.0 / 5287 (MPL 2.0), مثبتة بواسطة SHA-256
