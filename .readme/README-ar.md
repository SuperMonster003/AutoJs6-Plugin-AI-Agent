...
معاينة تطوير للإصدار 1.0.0. تم تنفيذ واجهات المهام ومداخل الاستخدام وتوثيق أدلة تدقيق P7. فحوص الإصدار والنشر في P8 لم تكتمل بعد. راجع [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md) للاختبارات الناجحة والقيود المعروفة.
