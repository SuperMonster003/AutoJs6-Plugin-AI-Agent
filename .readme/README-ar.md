...
معاينة تطوير: تتوفر شاشات P6 والإعدادات والكرة العائمة والمشاركة والاختصارات والمسودات الصوتية. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. لا تزال اختبارات الاعتمادية والإصدار في P7/P8 معلقة. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> معاينة تطوير: تتوفر شاشات P6 والإعدادات والكرة العائمة والمشاركة والاختصارات والمسودات الصوتية. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. لا تزال اختبارات الاعتمادية والإصدار في P7/P8 معلقة.
...
- `تلميح` معاينة تطوير: تتوفر شاشات P6 والإعدادات والكرة العائمة والمشاركة والاختصارات والمسودات الصوتية. تتطلب ai.agent إصدار AutoJs6 build 5293 أو أحدث. لا تزال اختبارات الاعتمادية والإصدار في P7/P8 معلقة.
- `ميزة` إدخال عائم اختياري وتقدم وإيقاف وبطاقات تأكيد ومشاركة نص واختصارات ثابتة وإعدادات مثبتة وتعرف صوتي من النظام يملأ المسودة دون إرسال تلقائي
- `ميزة` إعدادات عامة وإدارة فئات البيانات وسجل وإشعارات قانونية دون اتصال وفحص تحديثات يدوي قابل للإلغاء مع تخزين يومي وتجاهل الإصدارات
