...
معاينة تطوير: تتوفر لوحة المهام P6.1 وسجل المهام P6.2. تتطلب واجهة ai.agent إصدار AutoJs6 build 5293 أو أحدث. تتابع الإعدادات المخصصة والواجهات الأخرى في P6.3-P6.7 وتبقى اختبارات الاعتمادية والإصدار في P7/P8. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> معاينة تطوير: تتوفر لوحة المهام P6.1 وسجل المهام P6.2. تتطلب واجهة ai.agent إصدار AutoJs6 build 5293 أو أحدث. تتابع الإعدادات المخصصة والواجهات الأخرى في P6.3-P6.7 وتبقى اختبارات الاعتمادية والإصدار في P7/P8.
...
- `تلميح` معاينة تطوير: تتوفر لوحة المهام P6.1 وسجل المهام P6.2. تتطلب واجهة ai.agent إصدار AutoJs6 build 5293 أو أحدث. تتابع الإعدادات المخصصة والواجهات الأخرى في P6.3-P6.7 وتبقى اختبارات الاعتمادية والإصدار في P7/P8.
