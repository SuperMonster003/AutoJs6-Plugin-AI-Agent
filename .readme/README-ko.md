...
> 개발 미리보기: P6.1-P6.4에서 작업 화면, 기록, 프리셋과 환경설정 메모리를 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 나머지 화면은 P6.5-P6.7, 안정성과 릴리스 조건은 P7/P8에 남아 있습니다.
...
- `힌트` 개발 미리보기: P6.1-P6.4에서 작업 화면, 기록, 프리셋과 환경설정 메모리를 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 나머지 화면은 P6.5-P6.7, 안정성과 릴리스 조건은 P7/P8에 남아 있습니다.
