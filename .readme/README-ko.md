...
> 개발 미리보기: P6.1 작업 화면과 P6.2 작업 기록을 사용할 수 있습니다. ai.agent API는 AutoJs6 build 5293 이상이 필요합니다. 사용자 프리셋과 기타 화면은 P6.3-P6.7에서, 안정성과 출시 검증은 P7/P8에서 계속합니다.
...
- `힌트` 개발 미리보기: P6.1 작업 화면과 P6.2 작업 기록을 사용할 수 있습니다. ai.agent API는 AutoJs6 build 5293 이상이 필요합니다. 사용자 프리셋과 기타 화면은 P6.3-P6.7에서, 안정성과 출시 검증은 P7/P8에서 계속합니다.
