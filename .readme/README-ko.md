...
개발 미리보기: P6.1-P6.3에서 작업 화면, 기록, 이름 있는 프리셋을 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 메모리 관리와 나머지 화면은 P6.4-P6.7, 안정성 및 출시 검증은 P7/P8에서 진행합니다. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 개발 미리보기: P6.1-P6.3에서 작업 화면, 기록, 이름 있는 프리셋을 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 메모리 관리와 나머지 화면은 P6.4-P6.7, 안정성 및 출시 검증은 P7/P8에서 진행합니다.
...
- `힌트` 개발 미리보기: P6.1-P6.3에서 작업 화면, 기록, 이름 있는 프리셋을 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 메모리 관리와 나머지 화면은 P6.4-P6.7, 안정성 및 출시 검증은 P7/P8에서 진행합니다.
