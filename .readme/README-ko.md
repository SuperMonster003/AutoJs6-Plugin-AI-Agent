...
P2.1 코어는 다음 30 개 도구를 정의합니다. 작업 실행과 확인 기능은 개발 중이며 이 표는 미리보기에서 작업을 실행할 수 있음을 의미하지 않습니다. 설명은 모델 도구 목록에서 생성됩니다 (영어 또는 중국어). P2.2 코어는 단일 단계 결정 검증과 영어/중국어 프롬프트 템플릿도 제공합니다. 작업 실행은 아직 연결되지 않았습니다.
