...
> 개발 미리 보기: 작업 화면, 기록, 프리셋, 메모리, 설정, 릴리스 기록과 수동 업데이트 확인을 제공합니다. ai.agent API는 AutoJs6 빌드 5293 이상이 필요합니다. 플로팅 및 외부 진입점은 P6.7, 안정성과 배포 검증은 P7/P8에서 계속합니다.
...
- INTERNET은 수동 GitHub 릴리스 확인에만 사용합니다. FOREGROUND_SERVICE와 FOREGROUND_SERVICE_SPECIAL_USE는 실행 중인 작업, POST_NOTIFICATIONS는 진행 상황과 중지 작업에 사용합니다. 접근성, 오버레이, 저장소 또는 마이크 권한은 요청하지 않습니다.
...
- `힌트` 개발 미리 보기: 작업 화면, 기록, 프리셋, 메모리, 설정, 릴리스 기록과 수동 업데이트 확인을 제공합니다. ai.agent API는 AutoJs6 빌드 5293 이상이 필요합니다. 플로팅 및 외부 진입점은 P6.7, 안정성과 배포 검증은 P7/P8에서 계속합니다.
