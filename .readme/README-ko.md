...
개발 미리보기: P6.1-P6.5에서 작업 화면, 기록, 프리셋과 환경설정 메모리를 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 나머지 화면은 P6.6-P6.7, 안정성과 릴리스 조건은 P7/P8에 남아 있습니다. [ROADMAP.md](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/blob/master/ROADMAP.md).
...
> 개발 미리보기: P6.1-P6.5에서 작업 화면, 기록, 프리셋과 환경설정 메모리를 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 나머지 화면은 P6.6-P6.7, 안정성과 릴리스 조건은 P7/P8에 남아 있습니다.
...
- 네트워크 권한이 필요하지 않습니다. FOREGROUND_SERVICE와 FOREGROUND_SERVICE_SPECIAL_USE는 실행 중인 작업에, POST_NOTIFICATIONS는 진행 상황과 중지 동작에 사용합니다. 접근성 및 오버레이 권한은 요청하지 않습니다.
...
- `힌트` 개발 미리보기: P6.1-P6.5에서 작업 화면, 기록, 프리셋과 환경설정 메모리를 제공합니다. ai.agent API에는 AutoJs6 빌드 5293 이상이 필요합니다. 나머지 화면은 P6.6-P6.7, 안정성과 릴리스 조건은 P7/P8에 남아 있습니다.
