...
> 개발 미리보기: 작업 화면에서 목표 입력, 진행 상황, 인라인 응답 및 최근 작업 상세 정보를 지원합니다. ai.agent 작업 API에는 AutoJs6 빌드 5293 이상이 필요합니다. 기록 관리, 사용자 프리셋 및 기타 진입점은 P6에서, 안정성 검증은 P7에서 계속됩니다.
...
- `힌트` 개발 미리보기: 작업 화면에서 목표 입력, 진행 상황, 인라인 응답 및 최근 작업 상세 정보를 지원합니다. ai.agent 작업 API에는 AutoJs6 빌드 5293 이상이 필요합니다. 기록 관리, 사용자 프리셋 및 기타 진입점은 P6에서, 안정성 검증은 P7에서 계속됩니다.
