...
개발 미리보기: 등록 스크립트의 매개변수 질문, 확인, 결과 보고 및 취소 지원. 화면 작업은 P4, 작업 스크립트 API와 작업대는 P5/P6에서 구현 예정.
...
1. AutoJs6 빌드 5287 이상이 설치된 기기에 [Releases](https://github.com/SuperMonster003/AutoJs6-Plugin-AI-Agent/releases)에서 플러그인 APK를 설치합니다.
...
- `개선` 플러그인의 추가 스크립트 폴더 설정을 수신하고 검증하기 위한 최소 호스트는 AutoJs6 6.8.0 / 빌드 5287
- `의존성` 동일한 AutoJs6 6.8.0 / 5287 release 빌드의 common-plugin-api, host-capability-api 및 ai-agent-api (MPL 2.0) 추가, SHA-256으로 고정
